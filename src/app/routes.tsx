...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: "council-admin/attendance", Component: CouncilAttendancePage },
      { path: "council-admin/attendance/quarterly-roster-audit", Component: CouncilQuarterlyRosterAuditPage },
    ],
  },
]);
