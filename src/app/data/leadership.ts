...
export const DEFAULT_LEADERSHIP_CONTENT: LeadershipContent = {
  executiveBoard: [
    ...
    { id: "eb-4", title: "Treasurer", name: "VACANT", chapter: "Appointment pending" },
    { id: "eb-5", title: "Financial Secretary", name: "Gibrill Kamara", chapter: "Alpha Phi Alpha Fraternity, Inc." },
    { id: "eb-6", title: "Parliamentarian", name: "Krystal Allbright", chapter: "Sigma Gamma Rho Sorority, Inc." },
  ...
  additionalChairs: [
    ...
    { id: "ch-2", title: "Fundraising Chair", name: "Dr. Azaria Cunningham", chapter: "Affiliation TBD" },
    { id: "ch-3", title: "Scholarship Chair", name: "Dr. Aaliyah Davis", chapter: "Affiliation TBD" },
  ],
};
