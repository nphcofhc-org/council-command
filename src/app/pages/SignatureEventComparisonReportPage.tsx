...
function SectionTitle({ children, id }: { children: React.ReactNode; id?: string }) {
  return (
    <div className="flex items-center justify-between gap-3">
      <h2 id={id} className="text-lg sm:text-xl font-extrabold tracking-tight text-white">
        {children}
      </h2>
      {id ? (
        <a
          href={`#${id}`}
          className="hidden sm:inline-flex items-center gap-1 text-xs text-white/60 hover:text-primary transition-colors"
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="min-w-0">
              <div className="flex items-center gap-3">
                <div className="rounded-xl border border-white/10 bg-white p-2 shadow-[0_16px_50px_rgba(0,0,0,0.35)]">
              ...
              <p className="text-sm text-white/75 mt-3 max-w-3xl">{reportMeta.subtitle}</p>
              <p className="text-xs text-white/55 mt-2 max-w-3xl">{reportMeta.mission}</p>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {reportMeta.links.map((l) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-3 py-2 text-xs text-white/85 hover:bg-white/10 transition"
                  >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-10 space-y-6">
        <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
          <CardHeader>
            ...
            <p className="text-sm text-white/70">This is the committee’s baseline context and what the decision is responding to.</p>
          </CardHeader>
        ...
        <Tabs defaultValue="comparison">
          <TabsList className="w-full justify-start bg-white/5 border border-white/10 backdrop-blur-xl">
          ...
          <TabsContent value="comparison" className="space-y-6">
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Qualitative ratings from the report are mapped to a 1-5 scale for visualization.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Scale Mapping</p>
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">What This Means</p>
                    <p className="text-sm text-white/70 mt-2">
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="text-sm text-white/70 mt-2">Use the Decision Portal to vote after reviewing the interactive report.</p>
            ...
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Tap a criterion to see the committee’s scoring language and the rationale in digest form.</p>
              </CardHeader>
              <CardContent>
                    ...
                    <AccordionItem key={c.id} value={c.id}>
                      ...
                      <AccordionContent>
                        <div className="grid gap-4 lg:grid-cols-2">
                          <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                            <p className="text-xs uppercase tracking-widest text-white/60">Unity BBQ</p>
                            <p className="text-sm text-white/75 mt-2">{c.unity.summary}</p>
                            {detailMode === "full" && c.unity.strengths?.length ? (
                              <div className="mt-3">
                                <p className="text-xs font-semibold text-white/80">Strengths</p>
                                <ul className="mt-1 list-disc ml-5 text-sm text-white/70 space-y-1">
                            ...
                            {detailMode === "full" && c.unity.limitations?.length ? (
                              <div className="mt-3">
                                <p className="text-xs font-semibold text-white/80">Limitations</p>
                                <ul className="mt-1 list-disc ml-5 text-sm text-white/70 space-y-1">
                          ...
                          <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                            <p className="text-xs uppercase tracking-widest text-white/60">Block Party</p>
                            <p className="text-sm text-white/75 mt-2">{c.block.summary}</p>
            ...
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              ...
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">Unity BBQ Advantages</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                ...
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">Block Party Advantages</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
            ...
            {detailMode === "full" ? (
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="text-sm text-white/70">Highlights pulled directly from the report’s assessment summary.</p>
                </CardHeader>
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Strengths to Leverage</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Challenges to Address</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                  ...
                  <div className="lg:col-span-2 rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Assessment Conclusion</p>
                    <p className="text-sm text-white/75 mt-2">{chapterAssessmentContext.assessmentConclusionQuote}</p>
                  </div>
                </CardContent>
              </Card>
            ) : null}
          ...
          <TabsContent value="concepts" className="space-y-6">
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">The committee evaluated both concepts across these nine dimensions.</p>
              </CardHeader>
              <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {evaluationFramework.map((f) => (
                  <div key={f} className="rounded-lg border border-white/10 bg-white/5 p-4">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="text-sm text-white/70">{concepts.unity.oneLine}</p>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Target Audience</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Primary Objectives</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
              ...
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="text-sm text-white/70">{concepts.block.oneLine}</p>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Target Audience</p>
          ...
          <TabsContent value="recommendations" className="space-y-6">
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Committee-recommended sequencing that uses both concepts.</p>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {detailMode === "full" ? (
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Rationale</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
            ...
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">If capacity or risk tolerance requires a more conservative first year.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div>
                  <p className="text-xs uppercase tracking-widest text-white/60">Path</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                ...
                {detailMode === "full" ? (
                  <div className="space-y-4">
                    <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                      <p className="text-xs uppercase tracking-widest text-white/60">Advantages</p>
                      <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                    ...
                    <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                      <p className="text-xs uppercase tracking-widest text-white/60">Limitations</p>
                      <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
            ...
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Use these to guide deliberation before submitting votes.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">Questions for the Full Body</p>
                  <ol className="mt-2 list-decimal ml-5 text-sm text-white/70 space-y-1">
                ...
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">Voting Options</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                ...
                {detailMode === "full" ? (
                  <div className="lg:col-span-2 rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Final Committee Statement</p>
                    <p className="text-sm text-white/75 mt-2">{decisionFramework.closingStatement}</p>
                  </div>
                ) : null}
              </CardContent>
            </Card>
          ...
          <TabsContent value="finance" className="space-y-6">
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Expense ranges from the report (first-year estimates).</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
            ...
            {detailMode === "full" ? (
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                <CardHeader>
                  ...
                  <p className="text-sm text-white/70">Report-provided ranges for sponsorship, in-kind support, and other cost offsets.</p>
                </CardHeader>
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Block Party</p>
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody>
                          {financialModels.block.netCostScenarios.map((r) => (
                            <tr key={r.scenario} className="border-b border-white/10 last:border-b-0">
                              <td className="py-2 pr-3 align-top font-semibold text-white">{r.scenario}</td>
                              <td className="py-2 pr-3 align-top text-white/70">{money(r.revenue)}</td>
            ...
            {detailMode === "full" ? (
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                ...
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Block Party Mitigation</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-widest text-white/60">Unity BBQ Introduction (2027)</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
            ...
            <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
              <CardHeader>
                ...
                <p className="text-sm text-white/70">Block Party has a moderate risk profile; Unity BBQ is lower-risk operationally.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">{riskMatrix.blockParty.title}</p>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {riskMatrix.blockParty.rows.map((r) => (
                          <tr key={r.risk} className="border-b border-white/10 last:border-b-0">
                            <td className="py-2 pr-3 align-top font-semibold text-white">{r.risk}</td>
                            <td className="py-2 pr-3 align-top text-white/70">{r.impact}</td>
                            <td className="py-2 align-top text-white/70">{r.mitigation}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-widest text-white/60">{riskMatrix.unityBBQ.title}</p>
                  <p className="text-sm text-white/70 mt-2">{riskMatrix.unityBBQ.overall}</p>
                  <ul className="mt-3 list-disc ml-5 text-sm text-white/70 space-y-1">
                ...
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    {implementationTimeline.blockParty.map((t) => (
                      <div key={t.label} className="rounded-lg border border-white/10 bg-white/5 p-4">
            ...
            {detailMode === "full" ? (
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                ...
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-sm font-semibold text-white">{successMetrics.blockParty.title}</p>
                    <p className="text-xs uppercase tracking-widest text-white/60 mt-3">Quantitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                      {successMetrics.blockParty.quantitative.map((b) => (
                        <li key={b}>{b}</li>
                      ))}
                    </ul>
                    <p className="text-xs uppercase tracking-widest text-white/60 mt-4">Qualitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                      {successMetrics.blockParty.qualitative.map((b) => (
                        <li key={b}>{b}</li>
                      ))}
                    </ul>
                    <p className="text-xs uppercase tracking-widest text-white/60 mt-4">Strategic Impact</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
                  ...
                  <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                    <p className="text-sm font-semibold text-white">{successMetrics.unityBBQ.title}</p>
                    <p className="text-xs uppercase tracking-widest text-white/60 mt-3">Quantitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-white/70 space-y-1">
            ...
            {detailMode === "full" ? (
              <Card className="shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                ...
                <CardContent>
                  <ul className="list-decimal ml-5 text-sm text-white/70 space-y-1">
                    {references.map((r) => (
                      <li key={r}>{r}</li>
                    ))}
                  </ul>
