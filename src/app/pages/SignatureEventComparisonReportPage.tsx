...
function SectionTitle({ children, id }: { children: React.ReactNode; id?: string }) {
  return (
    <div className="flex items-center justify-between gap-3">
      <h2 id={id} className="text-lg sm:text-xl font-extrabold tracking-tight text-black">
        {children}
      </h2>
      {id ? (
        <a
          href={`#${id}`}
          className="hidden sm:inline-flex items-center gap-1 text-xs text-gray-500 hover:text-black"
...
export function SignatureEventComparisonReportPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <header className="bg-black text-white py-8 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="min-w-0">
              <div className="flex items-center gap-3">
                <img src={LOGO_URL} alt="NPHC of Hudson County Logo" className="h-10 w-auto" />
                <div className="min-w-0">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-10 space-y-6">
        <Card className="border border-gray-200 shadow-sm">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">This is the committee’s baseline context and what the decision is responding to.</p>
          </CardHeader>
          <CardContent className="grid gap-3 md:grid-cols-2">
            {keyFindings.map((k) => (
              <div key={k} className="rounded-lg border border-gray-100 bg-white p-4">
                <p className="text-sm text-gray-800">{k}</p>
              </div>
            ))}
          </CardContent>
        </Card>
          ...
          <TabsContent value="comparison" className="space-y-6">
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Qualitative ratings from the report are mapped to a 1-5 scale for visualization.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="h-[360px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart data={radarData}>
                      ...
                      <Radar name="Unity BBQ" dataKey="unity" stroke="#111827" fill="#111827" fillOpacity={0.15} />
                      <Radar name="Block Party" dataKey="block" stroke="#d4af37" fill="#d4af37" fillOpacity={0.15} />
                      <Legend />
                    </RadarChart>
                  </ResponsiveContainer>
                </div>
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Scale Mapping</p>
                  ...
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">What This Means</p>
                    <p className="text-sm text-gray-700 mt-2">
                  ...
                  <div className="rounded-lg border border-gray-100 p-4">
                    ...
                    <p className="text-sm text-gray-700 mt-2">Use the Decision Portal to vote after reviewing the interactive report and/or PDF.</p>
                    <a className="inline-flex items-center gap-2 mt-3 text-sm font-semibold text-black hover:underline" href="#/decision-portal">
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Tap a criterion to see the committee’s scoring language and the rationale in digest form.</p>
              </CardHeader>
              <CardContent>
                    ...
                    <AccordionItem key={c.id} value={c.id}>
                      ...
                      <AccordionContent>
                        <div className="grid gap-4 lg:grid-cols-2">
                          <div className="rounded-lg border border-gray-100 p-4">
                            <p className="text-xs uppercase tracking-widest text-gray-500">Unity BBQ</p>
                            <p className="text-sm text-gray-800 mt-2">{c.unity.summary}</p>
                            ...
                            {detailMode === "full" && c.unity.limitations?.length ? (
                              <div className="mt-3">
                                <p className="text-xs font-semibold text-gray-700">Limitations</p>
                                <ul className="mt-1 list-disc ml-5 text-sm text-gray-700 space-y-1">
                          ...
                          <div className="rounded-lg border border-gray-100 p-4">
                            <p className="text-xs uppercase tracking-widest text-gray-500">Block Party</p>
                            <p className="text-sm text-gray-800 mt-2">{c.block.summary}</p>
            ...
            {detailMode === "full" ? (
              <Card className="border border-gray-200 shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">Highlights pulled directly from the report’s assessment summary.</p>
                </CardHeader>
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Strengths to Leverage</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                  ...
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Challenges to Address</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                  ...
                  <div className="lg:col-span-2 rounded-lg border border-gray-100 bg-gray-50 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Assessment Conclusion</p>
                    <p className="text-sm text-gray-800 mt-2">{chapterAssessmentContext.assessmentConclusionQuote}</p>
                  </div>
                </CardContent>
              </Card>
            ) : null}
          ...
          <TabsContent value="concepts" className="space-y-6">
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">The committee evaluated both concepts across these nine dimensions.</p>
              </CardHeader>
              <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {evaluationFramework.map((f) => (
                  <div key={f} className="rounded-lg border border-gray-100 p-4">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <Card className="border border-gray-200 shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">{concepts.unity.oneLine}</p>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Target Audience</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                  ...
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Primary Objectives</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
              ...
              <Card className="border border-gray-200 shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">{concepts.block.oneLine}</p>
                </CardHeader>
                <CardContent className="space-y-5">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Target Audience</p>
          ...
          <TabsContent value="recommendations" className="space-y-6">
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Committee-recommended sequencing that uses both concepts.</p>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {detailMode === "full" ? (
                  <div className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Rationale</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">If capacity or risk tolerance requires a more conservative first year.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div>
                  <p className="text-xs uppercase tracking-widest text-gray-500">Path</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                ...
                {detailMode === "full" ? (
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-100 p-4">
                      <p className="text-xs uppercase tracking-widest text-gray-500">Advantages</p>
                      <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                    ...
                    <div className="rounded-lg border border-gray-100 p-4">
                      <p className="text-xs uppercase tracking-widest text-gray-500">Limitations</p>
                      <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Use these to guide deliberation before submitting votes.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-lg border border-gray-100 p-4">
                  <p className="text-xs uppercase tracking-widest text-gray-500">Questions for the Full Body</p>
                ...
                <div className="rounded-lg border border-gray-100 p-4">
                  <p className="text-xs uppercase tracking-widest text-gray-500">Voting Options</p>
                  <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                ...
                {detailMode === "full" ? (
                  <div className="lg:col-span-2 rounded-lg border border-gray-100 bg-gray-50 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Final Committee Statement</p>
                    <p className="text-sm text-gray-800 mt-2">{decisionFramework.closingStatement}</p>
                  </div>
                ) : null}
              </CardContent>
            </Card>
          ...
          <TabsContent value="finance" className="space-y-6">
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Expense ranges from the report (first-year estimates).</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={budgetChartData} layout="vertical" margin={{ left: 20, right: 20 }}>
                      ...
                      <Bar dataKey="span" stackId="a" fill="#111827" radius={[6, 6, 6, 6]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
            ...
            {detailMode === "full" ? (
              <Card className="border border-gray-200 shadow-sm">
                <CardHeader>
                  ...
                  <p className="text-sm text-gray-600">Report-provided ranges for sponsorship, in-kind support, and other cost offsets.</p>
                </CardHeader>
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-xs uppercase tracking-widest text-gray-500">Block Party</p>
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <p className="text-sm text-gray-600">Block Party has a moderate risk profile; Unity BBQ is lower-risk operationally.</p>
              </CardHeader>
              <CardContent className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-lg border border-gray-100 p-4">
                  <p className="text-xs uppercase tracking-widest text-gray-500">{riskMatrix.blockParty.title}</p>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {riskMatrix.blockParty.rows.map((r) => (
                          <tr key={r.risk} className="border-b last:border-b-0">
                            <td className="py-2 pr-3 align-top font-semibold text-gray-900">{r.risk}</td>
                            <td className="py-2 pr-3 align-top text-gray-700">{r.impact}</td>
                            <td className="py-2 align-top text-gray-700">{r.mitigation}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                <div className="rounded-lg border border-gray-100 p-4">
                  <p className="text-xs uppercase tracking-widest text-gray-500">{riskMatrix.unityBBQ.title}</p>
                  <p className="text-sm text-gray-700 mt-2">{riskMatrix.unityBBQ.overall}</p>
                ...
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    {implementationTimeline.blockParty.map((t) => (
                      <div key={t.label} className="rounded-lg border border-gray-100 p-4">
            ...
            {detailMode === "full" ? (
              <Card className="border border-gray-200 shadow-sm">
                ...
                <CardContent className="grid gap-6 lg:grid-cols-2">
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-sm font-semibold text-gray-900">{successMetrics.blockParty.title}</p>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mt-3">Quantitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                      {successMetrics.blockParty.quantitative.map((b) => (
                        <li key={b}>{b}</li>
                      ))}
                    </ul>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mt-4">Qualitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                      {successMetrics.blockParty.qualitative.map((b) => (
                        <li key={b}>{b}</li>
                      ))}
                    </ul>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mt-4">Strategic Impact</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
                  ...
                  <div className="rounded-lg border border-gray-100 p-4">
                    <p className="text-sm font-semibold text-gray-900">{successMetrics.unityBBQ.title}</p>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mt-3">Quantitative</p>
                    <ul className="mt-2 list-disc ml-5 text-sm text-gray-700 space-y-1">
            ...
            {detailMode === "full" ? (
              <Card className="border border-gray-200 shadow-sm">
                ...
                <CardContent>
                  <ul className="list-decimal ml-5 text-sm text-gray-700 space-y-1">
                    {references.map((r) => (
                      <li key={r}>{r}</li>
                    ))}
                  </ul>
