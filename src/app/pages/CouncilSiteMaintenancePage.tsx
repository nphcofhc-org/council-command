    ...
    <PresidentGate>
      <div className="relative min-h-screen p-4 sm:p-8">
        <div className="mx-auto max-w-7xl space-y-4">
          ...
          <ChapterDuesTrackerPanel description="Track the date each chapter paid dues. Treasury leadership can also update this record from the dedicated Chapter Dues page." />
